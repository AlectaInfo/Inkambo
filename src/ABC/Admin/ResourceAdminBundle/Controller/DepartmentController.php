...
use ABC\Admin\ResourceAdminBundle\Entity\Department;
use ABC\Admin\ResourceAdminBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABCAdminResourceAdminBundle:Department')->findAll();
        $count = count($entities);
        //$test=array_multisort($entities);
        return $this->render('ABCAdminResourceAdminBundle:Department:showAll.html.twig', array(
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABCAdminResourceAdminBundle:Department')->find($id);
        ...
        return $this->render('ABCAdminResourceAdminBundle:Department:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ABCAdminResourceAdminBundle:Department:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new DepartmentType(), $entity, array(
            'action' => $this->generateUrl('department_update', array('id' => $entity->getName())),
            'method' => 'PUT',
        ));
