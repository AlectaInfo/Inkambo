...
//            ))
            ...
            ->add('deptName','entity',array(
                'class'=>'ABCAdminResourceAdminBundle:Department',
                'property'=>'name',
                'label'=>'Department',
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ABC\Admin\ResourceAdminBundle\Entity\Resourceperson'
        ));
    }
    ...
    {
        return 'abc_admin_resourceadminbundle_resourceperson';
    }
}
